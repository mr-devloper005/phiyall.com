...
const inputClass = 'h-12 rounded-2xl border border-[var(--editable-border)] bg-white/92 px-4 text-base font-black text-current outline-none transition placeholder:text-current/35 focus:border-current focus:bg-white'
